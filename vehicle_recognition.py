...
train_datagen = img_train_gen.flow_from_directory(batch_size=batch_size,
...
val_datagen = img_val_gen.flow_from_directory(batch_size=batch_size,
                                            directory=val_data,
                                            shuffle=True,
                                            target_size=(img_width,img_height),
                                            class_mode='binary') 

# model, 4 convolution layers with maxpooling
